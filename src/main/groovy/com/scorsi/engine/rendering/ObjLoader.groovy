...
class ObjLoader {
    ...
    static Mesh loadMesh(String fileName) throws Exception {
        List<String> lines = Utils.readAllLines("/models/" + fileName)
    ...
    private static void processFaceVertex(IdxGroup indices, List<Vector2f> textCoordList,
        ...
        if (indices.idxTextCoord >= 0) {
            ...
            texCoordArr[posIndex * 2 + 1] = 1f - textCoord.y as float
        }
